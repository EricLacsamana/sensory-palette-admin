...
import {
    ...
    Undo2,
    Redo2,
    Stethoscope, // Swapped Users for Stethoscope
    X,
    ChevronsUpDown,
    Check,
} from 'lucide-react';
...
interface AppointmentHeaderProps {
    ...
    canRedo: boolean;
    isDirty: boolean;
    onChangeTherapist?: () => void; // Replaced isShowOtherUsers
    onClose?: () => void;
}
                                ...
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <Button
                                            ...
                                            className="h-8 w-8 rounded-md text-slate-500 hover:text-indigo-600 hover:bg-indigo-50"
                                        >
                                            <Stethoscope size={16} />
                                        </Button>
                                    </TooltipTrigger>
